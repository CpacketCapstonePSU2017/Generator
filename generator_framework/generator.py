"""
    ...
    Every distribution function is represented by a class, which is located in the resources folder.
        ...
        - To add a new distribution function;
            simply use the format of the two existing functions but insert the functionality of the new function.
            Create a class named after the function name and put it in an appropriately named file in the resources folder.

    write_data_to_csv takes the data generated by the distribution function and puts it in a csv file, which will be
...
class Generator:
    def __init__(self, config_object=None):
        '''
        Initialization for the Generator class

        :param config_object: GeneratorConfig object to set Generator configuration. If blank, will use
        hardcoded values in generator_config.py file
        '''
    ...
    def write_data_to_csv(self):
        '''
        Takes the data generated by the distribution function and puts it in a csv file, which will be located
    ...
    def write_data_to_database(self):
        '''
        Takes the generated data and puts it in a csv, and then transfers it to InfluxDB.
